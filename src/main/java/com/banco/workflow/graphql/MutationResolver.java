    ...
    public Policy createPolicy(@Argument Map<String, Object> input) {
        try {
            ...
            return policyService.createPolicy(
                    ...
                    bpmnXml,
                    input.get("umlActivityJson") instanceof Map<?, ?> uml ? (Map<String, Object>) uml : null,
                    input.get("umlVersion") instanceof String umlVersion ? umlVersion : null,
                    input.get("diagramNotation") instanceof String diagramNotation ? diagramNotation : null,
                    List.of(),
                    List.of(),
